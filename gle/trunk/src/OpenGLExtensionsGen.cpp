...
const int32	OpenGLExtensionsGen::m_supportedExtensionCount	= 262;
const int32	OpenGLExtensionsGen::m_supportedProcCount			= 1086;
...
void OpenGLExtensionsGen::initialize()
{
	...
	strStream2 << m_initializedExtensionCount << "/" << static_cast<uint32>(extensions.size() + wextensions.size());
...
{
	int32	localSupportedProcCount 	= 0;
	int32	localInitializedProcCount	= 0;
	...
	if ( isGL_3DFX_tbuffer ) // || isSEDEnable()
	{
		...
		if ( glTbufferMask3DFX != 0 )
		{
			++localInitializedProcCount;
		}
	} // if ( isGL_3DFX_tbuffer || isSEDEnable() )
...
void OpenGLExtensionsGen::initializeGL_APPLE()
{
	...
	if ( isGL_APPLE_element_array ) // || isSEDEnable()
	{
		...
		if ( glMultiDrawRangeElementArrayAPPLE != 0 )
		{
			++localInitializedProcCount;
		}
	} // if ( isGL_APPLE_element_array || isSEDEnable() )
...
void OpenGLExtensionsGen::initializeGL_ATI()
{
	...
	if ( isGL_ATI_vertex_attrib_array_object ) // || isSEDEnable()
	{
		...
		if ( glVertexAttribArrayObjectATI != 0 )
		{
			++localInitializedProcCount;
		}
		...
		if ( glGetVertexAttribArrayObjectfvATI != 0 )
		{
			++localInitializedProcCount;
		}
		...
		if ( glGetVertexAttribArrayObjectivATI != 0 )
		{
			++localInitializedProcCount;
		}
	} // if ( isGL_ATI_vertex_attrib_array_object || isSEDEnable() )
...
void OpenGLExtensionsGen::initializeGL_EXT()
{
	...
	if ( isGL_EXT_blend_equation_separate ) // || isSEDEnable()
	{
		...
		if ( glBlendEquationSeparateEXT != 0 )
		{
			++localInitializedProcCount;
		}
	} // if ( isGL_EXT_blend_equation_separate || isSEDEnable() )
	...
	isGL_EXT_color_matrix = isExtensionSupported("GL_EXT_color_matrix");
	
	localSupportedProcCount		= 0;
	localInitializedProcCount	= 0;
	
	
	if ( isGL_EXT_color_matrix )
	{
		std::stringstream strStream;
		strStream << "GL_EXT_color_matrix                                         : detected, " << localInitializedProcCount << "/" << localSupportedProcCount << " procedures initialized." << std::ends << std::endl;
		log( strStream.str() );

		if ( localInitializedProcCount < localSupportedProcCount  )
		{
			std::stringstream strStream;
			strStream << "GL_EXT_color_matrix                                         : " << localSupportedProcCount-localInitializedProcCount;
			strStream << " missing entry point(s), is there a bug in the driver !!!" << std::ends << std::endl;
			log( strStream.str() );
		}
		else
		{
			m_initializedExtensions.push_back( std::string("GL_EXT_color_matrix") );
			++m_initializedExtensionCount;
			m_initializedProcCount += localInitializedProcCount;
		}
	}
	...
	{
		logEndl( "GL_EXT_color_matrix                                         : not detected." );
	}
...
void OpenGLExtensionsGen::initializeGL_HP()
{
	...
	if ( isGL_HP_image_transform ) // || isSEDEnable()
	{
		...
		if ( glGetImageTransformParameterivHP != 0 )
		{
			++localInitializedProcCount;
		}
		...
		if ( glGetImageTransformParameterfvHP != 0 )
		{
			++localInitializedProcCount;
		}
	} // if ( isGL_HP_image_transform || isSEDEnable() )
...
void OpenGLExtensionsGen::initializeGL_NV()
{
	...
	if ( isGL_NV_register_combiners ) // || isSEDEnable()
	{
		...
		if ( glGetCombinerOutputParameterfvNV != 0 )
		{
			++localInitializedProcCount;
		}
		...
		if ( glGetCombinerOutputParameterivNV != 0 )
		{
			++localInitializedProcCount;
		}
		...
		if ( glGetFinalCombinerInputParameterfvNV != 0 )
		{
			++localInitializedProcCount;
		}
		...
		if ( glGetFinalCombinerInputParameterivNV != 0 )
		{
			++localInitializedProcCount;
		}
	} // if ( isGL_NV_register_combiners || isSEDEnable() )
	...
	if ( isGL_NV_register_combiners2 ) // || isSEDEnable()
	{
		...
		if ( glGetCombinerStageParameterfvNV != 0 )
		{
			++localInitializedProcCount;
		}
	} // if ( isGL_NV_register_combiners2 || isSEDEnable() )
...
void OpenGLExtensionsGen::initializeGL_SGIX()
{
	...
	if ( isGL_SGIX_polynomial_ffd ) // || isSEDEnable()
	{
		...
		if ( glLoadIdentityDeformationMapSGIX != 0 )
		{
			++localInitializedProcCount;
		}
	} // if ( isGL_SGIX_polynomial_ffd || isSEDEnable() )
...
void OpenGLExtensionsGen::initializeGL_SUN()
{
	...
	if ( isGL_SUN_vertex ) // || isSEDEnable()
	{
		...
		if ( glTexCoord2fNormal3fVertex3fvSUN != 0 )
		{
			++localInitializedProcCount;
		}
		...
		if ( glTexCoord2fColor4fNormal3fVertex3fSUN != 0 )
		{
			++localInitializedProcCount;
		}
		...
		if ( glTexCoord2fColor4fNormal3fVertex3fvSUN != 0 )
		{
			++localInitializedProcCount;
		}
		...
		if ( glTexCoord4fColor4fNormal3fVertex4fSUN != 0 )
		{
			++localInitializedProcCount;
		}
		...
		if ( glReplacementCodeuiColor4ubVertex3fSUN != 0 )
		{
			++localInitializedProcCount;
		}
		...
		if ( glReplacementCodeuiColor4ubVertex3fvSUN != 0 )
		{
			++localInitializedProcCount;
		}
		...
		if ( glReplacementCodeuiColor3fVertex3fSUN != 0 )
		{
			++localInitializedProcCount;
		}
		...
		if ( glReplacementCodeuiColor3fVertex3fvSUN != 0 )
		{
			++localInitializedProcCount;
		}
		...
		if ( glReplacementCodeuiNormal3fVertex3fSUN != 0 )
		{
			++localInitializedProcCount;
		}
		...
		if ( glReplacementCodeuiNormal3fVertex3fvSUN != 0 )
		{
			++localInitializedProcCount;
		}
		...
		if ( glReplacementCodeuiColor4fNormal3fVertex3fSUN != 0 )
		{
			++localInitializedProcCount;
		}
		...
		if ( glReplacementCodeuiColor4fNormal3fVertex3fvSUN != 0 )
		{
			++localInitializedProcCount;
		}
		...
		if ( glReplacementCodeuiTexCoord2fVertex3fSUN != 0 )
		{
			++localInitializedProcCount;
		}
		...
		if ( glReplacementCodeuiTexCoord2fVertex3fvSUN != 0 )
		{
			++localInitializedProcCount;
		}
		...
		if ( glReplacementCodeuiTexCoord2fNormal3fVertex3fSUN != 0 )
		{
			++localInitializedProcCount;
		}
		...
		if ( glReplacementCodeuiTexCoord2fNormal3fVertex3fvSUN != 0 )
		{
			++localInitializedProcCount;
		}
		...
		if ( glReplacementCodeuiTexCoord2fColor4fNormal3fVertex3fSUN != 0 )
		{
			++localInitializedProcCount;
		}
		...
		if ( glReplacementCodeuiTexCoord2fColor4fNormal3fVertex3fvSUN != 0 )
		{
			++localInitializedProcCount;
		}
	} // if ( isGL_SUN_vertex || isSEDEnable() )
...
void OpenGLExtensionsGen::initializeGL_VERSION()
{
	...
	if ( glDisableVertexAttribArray != 0 )
	{
		localInitializedProcCount++;
	}
